...
const formData = ref({
  ...
  riders: {
    ...
    // group2 — Инвалидность от НС
    disability_accident_lumpsum: { enabled: false },
    // group3 — Травмы и госпитализация
...
/* ══════════ UX-полировка: прогресс, интерактивные шаги, reveal ══════════ */
...
/* Pop галочки при завершении шага */
.ph-step-done .ph-step-num {
...
/* Кнопка «Рассчитать»: разовый блик при активации */
.ph-calc-btn {
  position: relative;
  overflow: hidden;
}
